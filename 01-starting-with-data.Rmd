...
We are studying inflammation in patients undergiong a new treatment for arthritis,
...
This tells us our data frame, `dat`, has `r nrow(dat)` rows and `r ncol(dat)` columns.
